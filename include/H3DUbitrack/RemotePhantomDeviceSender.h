...
#ifndef REMOTEPHANTOMDEVICESENDER_H_
#define REMOTEPHANTOMDEVICESENDER_H_
...
class H3DUBITRACK_API RemotePhantomDeviceSender : public MeasurementSenderBase {

public:
    RemotePhantomDeviceSender( H3D::Inst< H3D::SFNode       > _metadata = 0,
...
protected:
    ...
    std::auto_ptr<RemotePhantomDeviceSenderHapticForceEffect> forceeffect;
