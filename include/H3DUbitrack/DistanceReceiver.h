...
#ifndef DISTANCERECEIVER_H_
#define DISTANCERECEIVER_H_
...
typedef MeasurementReceiver<Ubitrack::Measurement::Distance , Ubitrack::Components::ApplicationPullSinkDistance> DistanceReceiverBase;

class H3DUBITRACK_API DistanceReceiver : public DistanceReceiverBase {

public:
    DistanceReceiver( H3D::Inst< H3D::SFNode     > _metadata = 0,
