...
#ifndef CALIBRATEDPHANTOMDEVICESENDER_H_
#define CALIBRATEDPHANTOMDEVICESENDER_H_
...
#include <H3DUbitrack/CalibratedPhantomDeviceSenderHapticForceEffect.h>
...
class H3DUBITRACK_API CalibratedPhantomDeviceSender : public MeasurementSenderBase {

public:
    CalibratedPhantomDeviceSender( H3D::Inst< H3D::SFNode       > _metadata = 0,
...
protected:
    ...
    std::auto_ptr<CalibratedPhantomDeviceSenderHapticForceEffect> forceeffect;
