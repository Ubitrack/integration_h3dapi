...
#include <CalibratedPhantom/CalibratedPhantomHapticsDevice.h>
...
CalibratedPhantomDeviceSenderHapticForceEffect::CalibratedPhantomDeviceSenderHapticForceEffect(
...
HAPIForceEffect::EffectOutput CalibratedPhantomDeviceSenderHapticForceEffect::calculateForces( const HAPIForceEffect::EffectInput &input) {
	bool ready = false;
