...
#include <H3DUbitrack/RemotePhantomDeviceSenderHapticForceEffect.h>

#include <H3DUbitrack/H3DUbitrack.h>
#include <H3DUbitrack/MeasurementSender.h>
#include <RemotePhantom/RemotePhantomHapticsDevice.h>
...
RemotePhantomDeviceSenderHapticForceEffect::RemotePhantomDeviceSenderHapticForceEffect(
...
HAPIForceEffect::EffectOutput RemotePhantomDeviceSenderHapticForceEffect::calculateForces( const HAPIForceEffect::EffectInput &input) {
	bool ready = false;
	...
	if (is_active && ready) {
		...
		RemotePhantom::RemotePhantomHapticsDevice* hd = static_cast<RemotePhantom::RemotePhantomHapticsDevice*>(input.hd);
